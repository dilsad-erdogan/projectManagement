      ...
      <div className='p-5 border rounded-2xl text-start'>
        ...
        {myAuctions.length > 0 ? (
          myAuctions.map((auction) => (
            <div key={auction._id} className='p-4 mb-2 border rounded-xl'>
      ...
      <div className='p-5 border rounded-2xl text-start'>
        ...
        {myPeriods.length > 0 ? (
          myPeriods.map((period) => (
            <div key={period._id} className='p-4 mb-2 border rounded-xl'>
      ...
      <div className='p-5 border rounded-2xl text-start'>
        ...
        {myJobsFromAgreements.length > 0 ? (
          myJobsFromAgreements.map((job) => (
            <div key={job._id} className='p-4 mb-2 border rounded-xl'>
